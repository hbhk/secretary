package org.hbhk.secretary.frontend.server.service.impl;
...
import org.hbhk.secretary.backend.server.dao.ISiteInfoDao;
import org.hbhk.secretary.backend.server.service.ISiteInfoService;
import org.hbhk.secretary.backend.shared.pojo.SiteInfo;
...
public class SiteInfoService implements ISiteInfoService {
	...
	public Pagination<SiteInfo> getPagination(Page page, Sort[] sorts,
			Map<String, Object> params) {
		return null;
	}

	public List<SiteInfo> getList(Map<String, Object> params) {
		return null;
	}
